...
sites = unique(siteTable$CouncilSiteID[siteTable$Agency%in%c('ecan')])
...
saveXML(con$value(), paste0("h:/ericg/16666LAWA/2018/WaterQuality/1.Imported/",format(Sys.Date(),"%Y-%m-%d"),"/ecanSWQ.xml"))
