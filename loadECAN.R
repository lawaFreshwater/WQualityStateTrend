...
if(Process){
  ...
  fname <- "//file/herman/R/OA/08/02/2018/Water Quality/R/lawa_state/2018_csv_config_files/ecanSWQ_config.csv"
  ...
  for(i in 1:length(sites)){
    ...
    for(j in 1:length(Measurements)){
      ...
      url <- paste("http://wateruse.ecan.govt.nz/wqlawa.hts?service=Hilltop",
                   "&request=GetData",
                   "&Site=",sites[i],
