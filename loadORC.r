...
## Write Hilltop XML for Water Quality Data
  ...
  fname <- "H:/ericg/16666LAWA/2018/WaterQuality/R/lawa_state/2018_csv_config_files/orcSWQ_config.csv"
  ...
  saveXML(con$value(), paste0("H:/ericg/16666LAWA/2018/WaterQuality/1.Imported/",format(Sys.Date(),"%Y-%m-%d"),"/orcSWQ.xml"))
