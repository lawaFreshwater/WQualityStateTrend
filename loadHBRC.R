...
message(paste("HBRC: Loading data from HBRC Hilltop Server"))
...
saveXML(con$value(), paste0("H:/ericg/16666LAWA/2018/WaterQuality/1.Imported/",format(Sys.Date(),"%Y-%m-%d"),"/hbrcSWQ.xml"))
cat("Finished",Sys.time()-tm,"\n")

#Rremove poporangi stream doubleups
